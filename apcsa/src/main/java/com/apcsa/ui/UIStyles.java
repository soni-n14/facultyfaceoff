...
/**
 * Provides shared style constants and helper methods for positioning and
 * styling all HUD elements.
 */
public class UIStyles {
    ...
    public static final String TOWER_PLACEMENT_BUTTON = "-fx-background-color: gray;" +
            "-fx-text-fill: black;" +
            "-fx-font-size: 14px;" +
    ...
    public static final String WAVE_TEXT = "-fx-font-family: 'Trebuchet MS';" +
            "-fx-font-size: 22px;" +
            "-fx-font-weight: bold;" +
            "-fx-fill: white;" +
            "-fx-stroke: black;" +
    ...
    public static final String MONEY_TEXT = "-fx-font-family: 'Impact';" +
            "-fx-font-size: 24px;" +
            "-fx-fill: #FFD84D;" +
            "-fx-stroke: black;" +
            "-fx-stroke-width: 1.5;";

    public static final String BASE_HEALTH_TEXT = "-fx-font-family: 'Verdana';" +
            "-fx-font-size: 23px;" +
            "-fx-font-weight: bold;" +
            "-fx-fill: #FF6B6B;" +
            "-fx-stroke: black;" +
